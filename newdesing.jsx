...
const Title = ({ kicker, children, sub, center = false }) => (
...
/* =============================
   ...
   ============================= */
const BeforeAfterSlider = ({ before, after, captionBefore = "До", captionAfter = "После" }) => {
  ...
  const onDown = (e) => {
    e.preventDefault();
    setFromEvent(e);
    const move = (ev) => { ev.preventDefault(); setFromEvent(ev); };
    const up = () => {
      ...
      <header className="sticky top-0 z-40 backdrop-blur supports-[backdrop-filter]:bg-zinc-950/60 border-b border-white/5">
        <Container className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="#demo" className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium hover:bg-white/10 transition">
              Попробовать демо
          ...
          <Container className="pt-20 pb-28 md:pt-28 md:pb-36">
            ...
            <FadeIn delay={0.15}>
              <div className="mt-8 flex flex-col sm:flex-row gap-3">
                <a href="#demo" className="inline-flex items-center justify-center gap-2 rounded-2xl border border-white/10 bg-zinc-100 text-zinc-950 px-6 py-3 font-medium hover:opacity-90 transition">
                  Попробовать демо <MousePointer className="h-4 w-4" />
                </a>
                <a href="#demo" className="inline-flex items-center justify-center gap-2 rounded-2xl border border-white/10 bg-white/5 px-6 py-3 font-medium hover:bg-white/10 transition">
      ...
      <Section id="how" className="py-12 md:py-20">
        <Container>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* 3. Конструктор с ИИ */}
            <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-zин-300"><Wand2 className="h-4 w-4" /> Конструктор + ИИ</div>
