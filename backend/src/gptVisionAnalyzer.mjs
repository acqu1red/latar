...
function createAnalysisPrompt(furnitureData) {
  ...
  return `Ты можешь сделать план по этой фотографии? Твоя задача перенести 2D план с фото полностью без твоих изменений.

Просто скопируй план как есть. Не добавляй ничего лишнего, не убирай ничего.
