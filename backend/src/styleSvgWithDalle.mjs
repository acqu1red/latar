...
export async function styleSvgWithDalle(svgDataUrl, rooms, totalSqm) {
  ...
  const prompt = [
    ...
    'Используй вход ТОЛЬКО как геометрию (точные контуры стен/проёмов/окон/иконок/текста).',
    'Ничего не добавляй, не удаляй и не смещай. Сохрани пропорции и позиции один в один.',
    'Стиль: чёрные линии на белом фоне; сохрани названия комнат и площадь (м²), убери только стрелки, легенды, компас, сетки, тени.',
    ...
    'Мебель: сохрани все иконки мебели как есть - диваны, кровати, столы, стулья, кухню, сантехнику.',
