...
import { LogOut, Image, Box, Eraser, Zap, Sparkles, Clock, Target, Workflow } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Загружаете фотографию помещения — получаете готовый 2D-план с точными размерами и расстановкой мебели.",
      gradient: "from-blue-500/20 to-cyan-500/20",
      borderColor: "border-blue-500/30",
      details: [
        "Автоматическое распознавание геометрии помещения",
        "Точные измерения стен, дверей и окон",
        "Определение расположения мебели",
        "Экспорт в различные форматы (PDF, DWG, PNG)"
      ]
    },
    {
      icon: Box,
      title: "AI Конструктор планов",
      description: "Интерактивный инструмент для создания планов помещений с помощью искусственного интеллекта.",
      gradient: "from-orange-500/20 to-red-500/20",
      borderColor: "border-orange-500/30",
      details: [
        "Интуитивный интерфейс перетаскивания",
        "Библиотека готовых элементов мебели",
        "Автоматическая оптимизация планировки",
    ...
    },
    {
      icon: Eraser,
      title: "Очистка фото",
      description: "Профессиональная обработка фотографий помещений с удалением лишних объектов и улучшением качества.",
      gradient: "from-purple-500/20 to-pink-500/20",
      borderColor: "border-purple-500/30",
      details: [
        "Удаление ненужных объектов с фотографий",
        "Восстановление фона после удаления",
        "Улучшение освещения и цветопередачи",
        "Подготовка фото для презентаций"
      ]
    },
    {
      icon: Zap,
      title: "Автоматизация бизнес-процессов",
      description: "Интеграция с вашими системами и автоматизация рутинных задач по работе с планами и фотографиями.",
      gradient: "from-green-500/20 to-emerald-500/20",
      borderColor: "border-green-500/30",
      details: [
        "API для интеграции с CRM и ERP системами",
        "Пакетная обработка больших объемов фото",
        "Автоматическое создание отчетов",
        "Настраиваемые workflow под вашу компанию"
      ]
    }
  ];
  ...
  const benefits = [
    {
      ...
      description: "Автоматизация процессов позволяет сократить время обработки фотографий и создания планов в 10 раз."
    },
    {
      icon: Target,
      title: "Высокая точность",
      description: "AI-алгоритмы обеспечивают точность измерений с погрешностью менее 2%, что соответствует профессиональным стандартам."
    },
    {
      icon: Workflow,
      title: "Гибкая интеграция",
      description: "Простое подключение к вашим существующим системам через API и готовые интеграции с популярными сервисами."
    }
  ];
          ...
          <div className="flex-1 flex justify-center">
            <nav className="hidden md:flex items-center gap-6 text-xs text-zinc-400">
              <div className="relative group">
                <a className="hover:text-zinc-100 transition cursor-pointer text-zinc-100 font-medium">
                  Возможности
        ...
        <Container className="py-16 sm:py-24">
          ...
          <FadeIn>
            <div className="text-center mb-16">
              ...
              <motion.p 
                className="text-lg sm:text-xl text-zinc-300 max-w-4xl mx-auto leading-relaxed"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.2 }}
              >
                Мощный набор AI-инструментов для автоматизации работы с планами помещений и фотографиями недвижимости
              </motion.p>
            </div>
          </FadeIn>
              ...
              return (
                <FadeIn key={idx} delay={0.3 + idx * 0.1}>
                  <motion.div
                    ...
                    className={`relative overflow-hidden rounded-2xl border ${feature.borderColor} bg-gradient-to-br ${feature.gradient} backdrop-blur-sm p-8 md:p-10`}
                  >
                    <div className="relative z-10">
                          ...
                          <ul className="space-y-3">
                            {feature.details.map((detail, detailIdx) => (
                              <li key={detailIdx} className="flex items-start gap-3">
                                ...
                                <span className="text-sm md:text-base text-zinc-200">{detail}</span>
                              </li>
                            ))}
                          </ul>
                        </div>
          ...
          <FadeIn delay={0.8}>
            <div className="max-w-4xl mx-auto mt-20 text-center">
              <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.08] to-white/[0.02] p-10 md:p-12">
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">
                  Готовы начать?
                </h3>
                <p className="text-base md:text-lg text-zinc-300 mb-8">
                  Оставьте заявку, и мы свяжемся с вами для обсуждения возможностей сотрудничества
                </p>
                <button 
                  onClick={() => navigate('/register')}
                  className="inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white text-zinc-950 px-8 py-3 text-base font-semibold hover:opacity-90 transition-opacity"
                >
                  Оставить заявку
